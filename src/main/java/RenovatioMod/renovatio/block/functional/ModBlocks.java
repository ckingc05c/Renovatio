...
public class ModBlocks {
    ...
    public static final Block IRON_BLAST_FURNACE = registerBlock("iron_blast_furnace",
            new IronBlastFurnaceBlock(FabricBlockSettings.copyOf(Blocks.BLAST_FURNACE)));
