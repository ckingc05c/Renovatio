...
/**
 * This class represents a custom hoe item.
 * It is a base class for other hoes.
 */
public class CustomHoeItem extends HoeItem {
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;
    private static final MeleeWeaponStats STATS = HoeWeaponStats.HOE;
    ...
    /**
     * Constructs a new CustomHoeItem.
