...
public class ModBlockEntities {
    ...
    public static void register() {
        IRON_BLAST_FURNACE = Registry.register(
                ...
                FabricBlockEntityTypeBuilder.create(IronBlastFurnaceBlockEntity::new, ModBlocks.IRON_BLAST_FURNACE).build(null)
        );

        EXTENDED_CRAFTING_TABLE = Registry.register(
                Registries.BLOCK_ENTITY_TYPE,
                new Identifier(Renovatio.MOD_ID, "extended_crafting_table"),
                FabricBlockEntityTypeBuilder.create(ExtendedCraftingTableBlockEntity::new, ModBlocks.EXTENDED_CRAFTING_TABLE).build(null)
        );
    }
}