...
import static ckingc05c.renovatio.item.ModMaterialItems.*;
...
public enum ModToolMaterials implements ToolMaterial {
    ...
    COPPER(324, 5.0F, 1.5F, 1, 12, () -> Ingredient.ofItems(Items.COPPER_INGOT)),
    ROSE_GOLD(436, 8.0F, 2.0F, 2, 20, () -> Ingredient.ofItems(ROSE_GOLD_INGOT)),
