...
import ckingc05c.renovatio.item.custom.equipment.tool.CustomPickaxeItem;
import ckingc05c.renovatio.item.custom.equipment.weapon.melee.axe.BattleAxeItem;
import ckingc05c.renovatio.item.custom.equipment.weapon.melee.axe.CustomAxeItem;
import ckingc05c.renovatio.item.custom.equipment.weapon.melee.sword.*;
import ckingc05c.renovatio.item.custom.equipment.weapon.melee.hoe.CustomHoeItem;
import ckingc05c.renovatio.item.custom.equipment.weapon.melee.hoe.ScytheHoeItem;
