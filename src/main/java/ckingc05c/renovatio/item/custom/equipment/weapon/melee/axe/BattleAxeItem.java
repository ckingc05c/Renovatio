package ckingc05c.renovatio.item.custom.equipment.weapon.melee.axe;
...
/**
 * This class represents a battle axe item.
 * It is a custom axe with balanced stats.
 */
public class BattleAxeItem extends AxeItem {
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;
    private static final MeleeWeaponStats STATS = AxeWeaponStats.BATTLE_AXE;
    ...
    /**
     * Constructs a new BattleAxeItem.
